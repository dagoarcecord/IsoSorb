...
class AdsorptionApp(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        # Selection radio: Isotermas / Cinéticas
        ...
        # Info label about expected columns
        ...
        # Estilo visual verde esmeralda sobre fondo oscuro
        ...
        # Options: initial guesses button (toggle show/hide)
        ...
        init_layout = QtWidgets.QFormLayout(self.init_area)
        self.init_edits = {}  # dict of parameter name -> QLineEdit
        ...
        # Right panel: plot and extra info
        ...
        # QTextBrowser for HTML fundamentos (stacked under canvas, hidden by default)
        ...
        # Styling suitable for dark theme (QTextBrowser shows HTML)
        ...
        # Download conclusions button (visible only when showing fundamentos)
        ...
        # Conectar la visibilidad del botón con el checkbox de overlay
    ...
    # -------------------------
    def load_csv(self):
        # When loading data, hide fundamentos automatically
    ...
    def fit_model(self):
        ...
        # If overlay is checked, fit selected models for the mode and plot them together
        ...
        # initial guesses from UI or defaults
        p0 = None
        if self.init_edits:
            try:
        ...
        # Determine model function and defaults
        ...
        # prepare results text with explicit parameter names + units
        self.results.clear()
        self.results.append(f"Model: {model}")
        # Friendly param labeling with typical units
        if self.rb_iso.isChecked() and model in MODELOS_ISOTERMAS:
    ...
    # -------------------------
    # Fit & plot all models on same axis (overlay) with selectable models
    # -------------------------
    def fit_and_plot_all_models(self):
        ...
        # show results summary in text box
        self.results.clear()
        ...
        # store last many-fit results for export and analysis
    ...
    # -------------------------
    # NUEVAS FUNCIONES: ANÁLISIS (Botón y Diálogo)
    # -------------------------
    ...
    "Model","R²","SSE","SAE","ARE","X²","HYBRID","MPSD","RMSE","SNE"
       ...
       # ------------------------------------------------
        ...
        try:
            ...
            # buscar ajuste del mejor modelo
            ajuste = None
                ...
                if modelo_func is None:
                    ...
                    if sigma == 0:
                        ...
                        if len(outliers) > 0:
                            ...
                            puntos = ", ".join(str(i+1) for i in outliers)

                            conclusion += (
                                f"{len(outliers)} possible outliers were detected "
                                f"at the experimental sites: {sites}.\n"
                            )
    ...
    # ------------------------------------------------
    # DISCUSIÓN CIENTÍFICA AUTOMÁTICA
    # ------------------------------------------------
...
<a href="manual" style="
    ...
    def download_manual(self):
        ...
        # 📄 Archivo origen (tu PDF ya existente)
    ...
    <h2 style="color:#00E5C0; font-size:20px;">Authors</h2>

    <p style="font-size:18px;">
        <li>Dagoberto Arce Córdova*</li>
        <li>Edith Erielia Gutiérrez Segura*</li>
        <li>Ruben Fernando Gutiérrez Hernández°</li>
        <li>Javier Francisco Valle Mora.°</li>
        <li>José Encarnación Moreno Marcelino*</li>
        <li>José Luis Maldonado°</li>
        <li>*Universidad Autónoma del Estado de México</li>
        <li>°Tecnológico Nacional de México Campus Tapachula</li>
    </p>
    ...
    <p style="font-size:18px;">
        <a style="color:#7CFFD8;" href="https://github.com/">
            GitHub Repository
        </a>
    </p>
    ...
    <p style="font-size:18px;">
        Arce, C. (2026). <i>Adsorption Analysis Tool</i> (Version 1.0) [Software].
        ...
        # ocultar botón de descargar conclusiones
        self.download_conc_btn.setVisible(False)
# ==================================================
# MAIN
# ==================================================
